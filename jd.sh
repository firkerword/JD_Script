...
COMMENT
	...
	random_jdglobal="$Oyeah_20200104_gb"
...
random_array() {
	...
	random_set=$(cat /tmp/random.txt | sed "s/$/@/" | sed ':t;N;s/\n//;b t' |sed 's/.$//g')
	echo $random_set
	read a
}
